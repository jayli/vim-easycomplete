...
" so use easycomplete#lsp#utils#position#lsp_to_vim instead
...
"   col
" ]
function! easycomplete#lsp#utils#position#lsp_to_vim(expr, position) abort
    let l:line = easycomplete#lsp#utils#position#lsp_line_to_vim(a:expr, a:position)
    let l:col = easycomplete#lsp#utils#position#lsp_character_to_vim(a:expr, a:position)
    return [l:line, l:col]
endfunction
...
" @returns
"   line
function! easycomplete#lsp#utils#position#lsp_line_to_vim(expr, position) abort
...
" @returns
"   line
function! easycomplete#lsp#utils#position#lsp_character_to_vim(expr, position) abort
...
"   'character': character
" }
function! easycomplete#lsp#utils#position#vim_to_lsp(expr, pos) abort
    return {
         \   'line': a:pos[0] - 1,
